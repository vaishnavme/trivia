...
export default function Playzone() {
    ...
    const { state: {currentQuiz, questionNo}, dispatch } = useData();
    ...
    return (
        <div className="m-auto w-full max-w-2xl">
            ...
            <div className="font-medium text-gray-600"><span className="text-2xl text-black">
                {questionNo + 1}</span>/{currentQuiz?.questions.length}
            </div>
            <div>
                <h1 className="text-xl font-medium p-2 mt-4">{currentQuestion?.question}</h1>
